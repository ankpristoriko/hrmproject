...
class SettingPermissions
{
    ...
    public function permissions()
    {
        return [
            ...
            [
                'name' => __t('master_settings'),
                'url' => route('support.settings.master',optional(tenant())->is_single ? '' : ['tenant_parameter' => tenant()->short_name ]),
                'permission' => authorize_any(['view_master_settings'])
            ],
            [
