...
class EmployeeController extends Controller
{
    ...
    public function show(User $employee)
    {
         $employee->load([
            'department:id,name',
            'designation:id,name',
            'profile:id,user_id,joining_date,employee_id,gender,date_of_birth,marital_status,number_of_children,nationality,religion_id,ethnicity_id,about_me,phone_number',
            'profilePicture',
            'workingShift:id,name',
            'employmentStatus:id,name,class,alias',
            'roles:id,name',
