...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo e(url('src/public/'.settings('tenant_icon', 'app_icon'))); ?>" />
    <link rel="apple-touch-icon" href="<?php echo e(url('src/public/'.settings('tenant_icon', 'app_icon'))); ?>" />
    <link rel="apple-touch-icon-precomposed" href="<?php echo e(url('src/public/'.settings('tenant_icon', 'app_icon'))); ?>" />
...
<?php /**PATH D:\laragon\www\hrmproject\src\resources\views/common/master.blade.php ENDPATH**/ ?>